...
namespace Freebie.Controllers
{
    public class AccInfoController : Controller
    {
        ...
        public ActionResult ViewAccProfile()
        {
            ...
            AccountQuota account_quota = db.AccountQuotas.Where(x => x.Account_Id == account_id).Where(x => x.Quota_Cd.Equals(base_quota_cd)).SingleOrDefault();
            ...
            if (agree_flag == "true")
            {
                ...
                {  
                    if (ModelState.IsValid)
                    {
                        ...
                        AccountQuota aq = db.AccountQuotas.Where(x => x.Account_Id.Equals(account_id)).Where(x => x.Quota_Cd.Equals(base_quota_cd)).SingleOrDefault();
